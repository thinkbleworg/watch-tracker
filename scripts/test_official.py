"""
Standalone test for the official-site scraper.
Doesn't touch Telegram or the real snapshot.

Usage:
    DRY_RUN=true python scripts/test_official.py
"""
...
from scrapers import HMTOfficialScraper

scraper = HMTOfficialScraper()
